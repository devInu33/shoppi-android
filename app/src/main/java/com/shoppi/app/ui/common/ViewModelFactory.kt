...
import com.shoppi.app.repository.category.CategoryRemotesDataSource
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(CategoryViewModel::class.java) -> {
                val repository =
                    CategoryRepository(CategoryRemotesDataSource(ServiceLocator.provideApiClient()))
            ...
            modelClass.isAssignableFrom(ProductDetailViewModel::class.java) -> {
                ...
                ProductDetailViewModel(
                    repository,
                    ServiceLocator.provideCartRepositroy(context)
                ) as T
            }
            modelClass.isAssignableFrom(CartViewModel::class.java) -> {

                CartViewModel(ServiceLocator.provideCartRepositroy(context)) as T
            }
            else -> {
